...
HtmlController.prototype.onWindowResize = function()
{
    ...
    this.sceneController.renderer.setSize( window.innerWidth/3-5, window.innerHeight-14);
	this.sceneController.clipRenderer.setSize(window.innerWidth/3-5, window.innerHeight-14);
	this.sceneController.screenRenderer.setSize(window.innerWidth/3-5, window.innerHeight-14);
