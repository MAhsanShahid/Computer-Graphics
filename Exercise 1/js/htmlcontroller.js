...
HtmlController.prototype.onDocumentKeyDown = function(event) {
    ...
    switch(keyCode)
    {
        case "r": // r
            ...
            break;
        case "s": 
            this.sceneController.selectChild("white");
            break; 
        case "w": 
            this.sceneController.selectParent("white");
            break;  
         case "d":
            this.sceneController.selectSibling("d");
            break; 
         case "a": 
            this.sceneController.selectSibling("a");
            break;
        case "c": 
            this.sceneController.toggleAxisVisibility();
            break;
        case "k": 
            this.sceneController.DanceRobot();
            break;       
        case "ArrowUp":
        ...
        case "ArrowDown":
            ...
            break;
        case "ArrowLeft":
            this.sceneController.rotateNodeZ(THREE.Vector3.XAxis, -3);
            break;
        case "ArrowRight":
            this.sceneController.rotateNodeZ(THREE.Vector3.XAxis, 3);
            break;  
        case "x":
            this.sceneController.rotateNodeY(THREE.Vector3.XAxis, -3);
            break;
        case "y":
            this.sceneController.rotateNodeY(THREE.Vector3.XAxis, 3);
            break;    
