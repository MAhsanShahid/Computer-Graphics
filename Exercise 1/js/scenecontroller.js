...
SceneController.prototype.DanceRobot = function()
{
    this.robot.DanceRobot();
};
...
SceneController.prototype.rotateNodeZ = function(axis, degree)
{
    this.robot.rotateOnAxisZ(axis, degree);
};
SceneController.prototype.rotateNodeY = function(axis, degree)
{
    this.robot.rotateOnAxisY(axis, degree);
};
